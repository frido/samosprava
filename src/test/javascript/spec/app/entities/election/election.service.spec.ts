...
import { IElection, Election, ElectionType } from 'app/shared/model/election.model';
...
describe('Service Tests', () => {
  describe('Election Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Election('ID', 'AAAAAAA', currentDate, ElectionType.DEPUTY);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Election', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            date: currentDate.format(DATE_FORMAT),
